...
import com.nadhem.users.service.exceptions.UserNameAlreadyExist;
...
public class UserServiceImpl implements UserService {
	...
	public User registerUser(RegistrationRequest request) {
		...
		User optionaluser1 = userRep.findByUsername(request.getUsername());
		if (optionaluser1 != null)
			throw new UserNameAlreadyExist("username déjà existant!");
